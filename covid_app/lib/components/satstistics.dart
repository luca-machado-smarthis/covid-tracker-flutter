              ...
              children: [
                ...
                Container(
                  decoration: BoxDecoration(
                    border: Border.all(
                      width: 2,
                      color: Color.fromARGB(255, 229, 239, 155)
                    ),
                ...
                Container(
                  decoration: BoxDecoration(
                    border: Border.all(
                      width: 2,
                      color: Color.fromARGB(255, 213, 215, 76)
                    ),
                    borderRadius: BorderRadius.circular(8)
                  ),
                  width: 850,
                ...
                Container(
                  decoration: BoxDecoration(
                    border: Border.all(
                      width: 2,
                      color: Color.fromARGB(255, 225, 109, 59)
                    ),
                    borderRadius: BorderRadius.circular(8)
                  ),
                  width: 850,
                ...
                Container(
                  decoration: BoxDecoration(
                    border: Border.all(
                      width: 2,
                      color: Color.fromARGB(255, 225, 31, 31)
                    ),
                    borderRadius: BorderRadius.circular(8)
                  ),
                  width: 850,
                ...
                Container(
                  decoration: BoxDecoration(
                    border: Border.all(
                      width: 2,
                      color: Color.fromARGB(255, 123, 235, 62)
                    ),
                    borderRadius: BorderRadius.circular(8)
                  ),
                  width: 850,
